...
namespace CRUSBL
{
    public interface ICRUSStoreFrontBL
    {
        /// <summary>
        ...
        List<CRUSStoreFront> GetAllCRUSStoreFront();
        ...
        CRUSStoreFront AddCRUSStoreFront(CRUSStoreFront p_rest);
        ...
        List<CRUSStoreFront> GetCRUSStoreFront(string p_name);